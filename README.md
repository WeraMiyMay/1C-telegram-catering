...
* **Просмотр меню, проверка лимитов и получение QR-кода:**  
  ![Просмотр меню и QR-код](bot_menu.png)

* **Поиск заказа и выдача кассиром:**  
  ![Интерфейс кассира](cashier_search.png)
